...
public class HeartBeatTimerHandler extends HeartBeatFilterHandler implements Runnable {
	public static final int DEFAULT_HEARTBEAT_INTERVAL = AdvancedProperties.getInstance().requireInteger("heartbeatInterval");
	public static final int DEFAULT_HEARTBEAT_TIMEOUT = AdvancedProperties.getInstance().requireInteger("heartbeatTimeout");
